...
window.onload = function () {
    ...
    function sayHello() {
        document.getElementById("output1").textContent =
            "Hello, classmate to my right: Madison!";
    }
...
// ===== EVENT LISTENERS THAT CALLS FUNCTIONS ===== //
    ...
    document.getElementById("btnDate").onclick = showDate;
    document.getElementById("btnMotivate").onclick = motivate;
    document.getElementById("btnRep").onclick = showRep;
